#!/usr/bin/env python3
"""
Тест с официальным аккаунтом Instagram (исправленная версия).
"""
...
async def test_instagram_fixed():
    """Тест с официальным аккаунтом Instagram (исправленная версия)."""
    ...
    screenshot_path = os.path.join(screenshots_dir, f"instagram_fixed_{username}_{timestamp}.png")
    
    print(f"🎯 Тест с официальным аккаунтом @{username} (исправленная версия)")
...
if __name__ == "__main__":
    print("🚀 Запуск теста с официальным аккаунтом Instagram (исправленная версия)")
    print("=" * 50)
    
    success = asyncio.run(test_instagram_fixed())
